...
def _contact_slots() -> list[dict[str, Any]]:
    ...
    return [
        ...
        _t(p, "form-label-slot", "聯絡・時段標籤", "希望預約時段（最多可選 3 組日期＋時段）", 24),
        _t(p, "form-opt-1", "聯絡・時段選項1", "尚未決定／稍後再約", 25),
        _t(p, "form-opt-2", "聯絡・時段選項2", "上午 10:00～11:00", 26),
        _t(p, "form-opt-3", "聯絡・時段選項3", "上午 11:00～12:00", 27),
        _t(p, "form-opt-4", "聯絡・時段選項4", "下午 1:30～2:30", 28),
        _t(p, "form-opt-5", "聯絡・時段選項5", "下午 2:30～3:30", 29),
        _t(p, "form-opt-6", "聯絡・時段選項6", "下午 3:30～4:30", 30),
        _t(p, "form-opt-7", "聯絡・時段選項7", "下午 4:30～5:30", 31),
        _t(p, "form-opt-8", "聯絡・時段選項8", "下午 5:30～6:30", 32),
        _t(p, "form-opt-9", "聯絡・時段選項9", "其他", 33),
        _t(p, "form-label-message", "聯絡・需求標籤", "您的需求 *", 34),
        _btn(p, "form-submit", "聯絡・送出按鈕", "送出留言", "", 35),
    ]

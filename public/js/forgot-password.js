  ...
  function init() {
    ...
    function setStep(step) {
      ...
      wizard.querySelectorAll('[data-fp-step]').forEach(function (el) {
        ...
        el.hidden = Number(el.getAttribute('data-fp-step')) !== step;
    ...
    wizard.querySelectorAll('[data-fp-next]').forEach(function (btn) {

      btn.addEventListener('click', function () {

        var next = Number(btn.getAttribute('data-fp-next'));

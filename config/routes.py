...
SERIES_FAMILY = PageMeta(
    ...
    og_image='images/hero/imprint-diamond-family-portrait-jewelry.jpg',
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('寵物鑽石', '/series/family/')],
    mvc_page=None,
    extra_body_class=None,
...
SERIES_HEIRLOOM = PageMeta(
    ...
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('寵物鑽石', '/series/heirloom/')],
    mvc_page=None,
    extra_body_class=None,
...
SERIES_LOVE = PageMeta(
    ...
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('寵物鑽石', '/series/love/')],
    mvc_page=None,
    extra_body_class=None,

...
PAGE_SERIES = PageMeta(
    ...
    title='六大系列總覽｜滿月・寵物・結髮・全家福・生命・真我鑽石－銘印鑽石 IMPRINT DIAMOND',
    description='銘印鑽石六大系列完整介紹：滿月、寵物、結髮、全家福、生命與真我鑽石。依您的羈絆與生命階段選擇系列，了解樣本來源、培育方式與線上試算。',
...
SERIES_SIGNATURE = PageMeta(
    ...
    template='pages/series_detail.html',
    title='真我鑽石｜專屬故事客製紀念鑽石－銘印鑽石 IMPRINT DIAMOND',
    description='真我鑽石｜以自己的髮絲，萃煉成獨一無二的鑽石，獻給值得被自己慶祝的此刻。全程台灣在地培育，可線上試算並由專屬顧問確認細節。',
    canonical_path='series/signature/',
    og_title='真我鑽石｜依故事量身打造的專屬 DNA 鑽石－銘印鑽石',
    og_description='真我鑽石，以自己的髮絲萃煉成獨一無二的鑽石，獻給值得被自己慶祝的此刻。',
    og_image='static/images/hero/imprint-diamond-wedding-couple-ring.jpg',

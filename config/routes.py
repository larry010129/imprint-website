...
PAGE_ABOUT = PageMeta(
    ...
    title='品牌故事｜銘印鑽石 — 紀念鑽石的陪伴與託付',
    description='銘印鑽石品牌故事：我們相信思念可以有具體的形狀，也理解每一段考慮期都值得被尊重。全程在地託付、不催促成交，陪伴您在自己的步調裡做出決定。DNA 鑽石製程詳見鑽石知識頁。',
    canonical_path='about.html',
    og_title='品牌故事－銘印鑽石 IMPRINT DIAMOND',
    og_description='在您準備好的時候，我們都在。紀念鑽石的陪伴、託付與服務承諾。',
...
PAGE_CONTACT = PageMeta(
    ...
    description='銘印鑽石聯絡資訊：新北市三重區福德南路43號1樓（預約制），官方 LINE 一對一顧問諮詢。全台唯一在地 DNA 鑽石培育實驗室，歡迎預約蒞臨。',
    canonical_path='contact.html',
    og_title='聯絡我們－銘印鑽石 IMPRINT DIAMOND',
    og_description='新北市三重區福德南路43號1樓（預約制），可透過官方 LINE 預約。',
    og_image='static/images/hero/imprint-diamond-family-memorial.jpg',
...
PAGE_GOLD_PRICE = PageMeta(
    ...
    description='即時黃金最新牌價，9K/14K/18K 成色金價換算，供戒台訂製試算參考。',
...
PAGE_WHAT_IS_DNA_DIAMOND = PageMeta(
    ...
    og_image='static/images/hero/imprint-diamond-family-memorial.jpg',
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('什麼是 DNA 鑽石', None)],
    mvc_page=None,
    extra_body_class=None,
    content_fragment=None,
    extra_head_blocks=[],
...
JEWELRY_STYLE_BRACELETS_BANGLE = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"手環\",\n  \"description\": \"硬版手環設計，鑽石鑲嵌其中，線條俐落有型，適合喜歡簡約俐落風格的您。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/bracelet-bangle-1.jpg\",\n  \"category\": \"Jewelry > 手鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"40000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/bracelets/bangle/\"\n  }\n}'],
)
...
JEWELRY_STYLE_BRACELETS_CHAIN = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"鎖鏈手鍊\",\n  \"description\": \"鍊節式設計搭配鑽石墜飾，適合與其他手鍊或手環疊戴，打造層次豐富的手部造型。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/bracelet-chain-1.jpg\",\n  \"category\": \"Jewelry > 手鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"40000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/bracelets/chain/\"\n  }\n}'],
)
...
JEWELRY_STYLE_BRACELETS_CHARM = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"墜飾手鍊\",\n  \"description\": \"單顆鑽石墜飾垂墜於鍊身之上，隨手腕擺動輕輕搖曳，溫柔而不張揚。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/bracelet-charm-1.jpg\",\n  \"category\": \"Jewelry > 手鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"40000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/bracelets/charm/\"\n  }\n}'],
)
...
JEWELRY_STYLE_BRACELETS_TENNIS = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"網球手鍊\",\n  \"description\": \"鑽石以鍊狀方式排列環繞手腕一圈，光芒連續不間斷，是經典不敗的手鍊款式。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/bracelet-tennis-1.jpg\",\n  \"category\": \"Jewelry > 手鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"40000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/bracelets/tennis/\"\n  }\n}'],
)
...
JEWELRY_STYLE_EARRINGS_DROP = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"垂墜耳環\",\n  \"description\": \"鑽石垂墜於耳下，隨著步伐輕輕搖曳，為整體造型增添柔美與動態感。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/earring-drop-1.jpg\",\n  \"category\": \"Jewelry > 耳環\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"62000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/earrings/drop/\"\n  }\n}'],
)
...
JEWELRY_STYLE_EARRINGS_EAR_CUFF = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"耳骨夾\",\n  \"description\": \"無需穿耳洞即可配戴的耳骨夾設計，鑽石鑲嵌於夾式耳骨環上，個性又百搭。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/earring-ear-cuff-1.jpg\",\n  \"category\": \"Jewelry > 耳環\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"62000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/earrings/ear-cuff/\"\n  }\n}'],
)
...
JEWELRY_STYLE_EARRINGS_HOOP = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"圈式耳環\",\n  \"description\": \"鑽石鑲嵌於俐落的圈環之上，線條簡潔有型，適合喜歡俐落風格的您。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/earring-hoop-1.jpg\",\n  \"category\": \"Jewelry > 耳環\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"62000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/earrings/hoop/\"\n  }\n}'],
)
...
JEWELRY_STYLE_EARRINGS_STUD = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"經典耳針\",\n  \"description\": \"鑽石緊貼耳垂配戴，款式簡約百搭，是最適合日常配戴的耳環款式。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/earring-stud-1.jpg\",\n  \"category\": \"Jewelry > 耳環\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"62000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/earrings/stud/\"\n  }\n}'],
)
...
JEWELRY_STYLE_NECKLACES_BAR = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"一字項鍊\",\n  \"description\": \"細長墜飾如一字排開，適合刻上重要的日期或文字，是紀念意義濃厚的簡約款式。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/necklace-bar-1.jpg\",\n  \"category\": \"Jewelry > 項鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"34000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/necklaces/bar/\"\n  }\n}'],
)
...
JEWELRY_STYLE_NECKLACES_CLASSIC_PENDANT = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"經典單鑽項鍊\",\n  \"description\": \"單顆主石垂墜於鍊身正中央，簡單卻最能凸顯鑽石本身的光芒，適合單獨配戴或作為紀念送禮首選。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/necklace-classic-pendant-1.jpg\",\n  \"category\": \"Jewelry > 項鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"34000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/necklaces/classic-pendant/\"\n  }\n}'],
)
...
JEWELRY_STYLE_NECKLACES_DOUBLE_LAYER = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"雙層項鍊\",\n  \"description\": \"雙層鍊身設計，可分別鑲嵌兩顆鑽石，適合同時紀念兩位重要的人，或紀念不同階段的重要時刻。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/necklace-double-layer-1.jpg\",\n  \"category\": \"Jewelry > 項鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"34000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/necklaces/double-layer/\"\n  }\n}'],
)
...
JEWELRY_STYLE_NECKLACES_HALO_PENDANT = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"光環墜飾項鍊\",\n  \"description\": \"主石周圍鑲嵌一圈小鑽，讓墜飾視覺份量更飽滿，光芒層次也更豐富。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/necklace-halo-pendant-1.jpg\",\n  \"category\": \"Jewelry > 項鍊\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"34000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/necklaces/halo-pendant/\"\n  }\n}'],
)
...
JEWELRY_STYLE_RINGS_CLASSIC_SOLITAIRE = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"經典單鑽戒指\",\n  \"description\": \"單一主石鑲嵌於簡約戒台之上，線條乾淨俐落，適合各種手型與風格，是最經典也最百搭的款式。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/ring-classic-solitaire-1.jpg\",\n  \"category\": \"Jewelry > 戒指\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"36000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/rings/classic-solitaire/\"\n  }\n}'],
)
...
JEWELRY_STYLE_RINGS_MODERN_BAND = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"極簡線戒\",\n  \"description\": \"極簡戒環設計，鑽石鑲嵌方式低調內斂，適合疊戴，也適合作為日常配戴的第一枚紀念戒指。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/ring-modern-band-1.jpg\",\n  \"category\": \"Jewelry > 戒指\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"36000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/rings/modern-band/\"\n  }\n}'],
)
...
JEWELRY_STYLE_RINGS_PAVE_HALO = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"華麗排鑽戒指\",\n  \"description\": \"主石周圍以一圈小鑽環繞鑲嵌，讓整體視覺份量感更足，光芒也更為集中閃耀，適合重要場合配戴。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/ring-pave-halo-1.jpg\",\n  \"category\": \"Jewelry > 戒指\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"36000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/rings/pave-halo/\"\n  }\n}'],
)
...
JEWELRY_STYLE_RINGS_VINTAGE_VINE = PageMeta(
    ...
    extra_head_blocks=['{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"Product\",\n  \"name\": \"復古藤蔓戒指\",\n  \"description\": \"戒台線條如藤蔓般蜿蜒纏繞，帶有復古細節與溫潤手感，適合喜歡低調精緻風格的您。\",\n  \"image\": \"https://www.imprint-diamond.com/static/images/products/ring-vintage-vine-1.jpg\",\n  \"category\": \"Jewelry > 戒指\",\n  \"brand\": {\n    \"@type\": \"Brand\",\n    \"name\": \"銘印鑽石 IMPRINT DIAMOND\"\n  },\n  \"offers\": {\n    \"@type\": \"AggregateOffer\",\n    \"priceCurrency\": \"TWD\",\n    \"lowPrice\": \"36000\",\n    \"highPrice\": \"990000\",\n    \"offerCount\": \"12\",\n    \"availability\": \"https://schema.org/InStock\",\n    \"url\": \"https://www.imprint-diamond.com/jewelry/rings/vintage-vine/\"\n  }\n}'],
)
...
SERIES_FAMILY = PageMeta(
    ...
    og_image='static/images/hero/imprint-diamond-family-portrait-jewelry.jpg',
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('全家福鑽石', '/series/family/')],
    mvc_page=None,
    extra_body_class=None,
...
SERIES_FIRST_LOVE = PageMeta(
    ...
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('滿月鑽石', '/series/first-love/')],
    mvc_page=None,
    extra_body_class=None,
...
SERIES_HEIRLOOM = PageMeta(
    ...
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('生命鑽石', '/series/heirloom/')],
    mvc_page=None,
    extra_body_class=None,
...
SERIES_LOVE = PageMeta(
    ...
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('結髮鑽石', '/series/love/')],
    mvc_page=None,
    extra_body_class=None,
...
SERIES_PET = PageMeta(
    ...
    breadcrumbs=[('首頁', '/'), ('DNA 鑽石', '/price.html'), ('寵物鑽石', '/series/pet/')],
    mvc_page=None,
    extra_body_class=None,

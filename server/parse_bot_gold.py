...
Ported from backend/lib/parseBotGold.js (originally bot_metal_feed.py).
Parsing rules are unchanged; only the HTML-query API differs (BeautifulSoup).
"""
...
def find_gold_bar_prices(html: str) -> dict[str, float | str | None] | None:
    """Return { perGram, stamp } or None if not found."""
